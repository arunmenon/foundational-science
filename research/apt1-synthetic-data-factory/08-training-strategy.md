...
**Grounding:** deep-research (2024-2026 agentic-training literature; 107-agent run, 23/25 claims verified, 2 refuted) + our factory artifacts ([README](README.md), [contract.md](contract.md), packs [04](04-ato-domain-pack.md)/[06](06-app-scams-domain-pack.md)/[07](07-commerce-disputes-domain-pack.md)).
